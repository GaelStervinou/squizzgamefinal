...
export class Migrations1704886647583 implements MigrationInterface {
    name = 'Migrations1704886647583'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "room" ("id" SERIAL NOT NULL, "password" character varying NOT NULL, "userLimit" integer NOT NULL, "timeLimit" integer NOT NULL, "isStarted" boolean NOT NULL DEFAULT false, "ownerId" integer, "quizzId" integer, CONSTRAINT "PK_c6d46db005d623e691b2fbcba23" PRIMARY KEY ("id"))`);
